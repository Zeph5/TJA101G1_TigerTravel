...
public interface TravelItineraryRepository extends JpaRepository<TravelItinerary, Integer> {
	...
	List<TravelItinerary> findByTravelPlan_TravelPlanId(Integer planId);

	List<TravelItinerary> findByTravelPlan_TravelPlanIdOrderByPublishedDateDesc(Integer planId);
